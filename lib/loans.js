...
// Note: isOverdue lives in lib/loan-display.js (client-safe) — it's the single
// source for the overdue rule, shared by the UI and the server-side loan
// queries. Don't reintroduce a copy here.
